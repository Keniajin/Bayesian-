...
mainDir <- "C:/Users/user/Desktop"
mainDir2 <-"C:/Users/user/Desktop/STAT 892"
BugDir<-"C:/winbugs14"
...
for (simudt in 1:300){
  ...
  AICls[simudt]=-2*ePost+2*32
  
}

#output result
result=cbind(elpdls,ePostls,pDICls,DICls,BICdimxls,BICparals,ePost,AICls)
